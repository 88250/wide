...
//	arrays of plugin or other methods to be triggered for events in *each layout* - will be passed 'Instance'
        ...
        , showInvisibly: function ($E, force) {
            if ($E && $E.length && (force || $E.css("display") === "none")) { // only if not *already hidden*
                ...
                $E.css({display: "flex", visibility: "hidden"});
                return CSS;
            }
            return {};
        }
...
//	DO NOT CHANGE the zIndex values below unless you clearly understand their relationships
        , zIndexes: {// set _default_ z-index values here...
            pane_normal: ''			// normal z-index for panes
        ...
        , north: {
            ...
            , resizerCursor: "row-resize"	// custom = url(myCursor.cur)
...
//,	hasParentLayout	= false	- exists ONLY inside Instance so can be set externally
        ...
        , setAsClosed = function (pane) {
            ...
            if ($T) {
                ...
                $T.children(".content-closed").css("display", "flex");
            }
        ...
        , setAsOpen = function (pane, skipCallback) {
            ...
            if ($T) {
                ...
                $T.children(".content-open").css("display", "flex");
            }
